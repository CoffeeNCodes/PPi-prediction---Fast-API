...
df['PPMdays'] = stats.mstats.winsorize(df['PPMdays'], limits=[0.01, 0.01])
df['Hemodialysis'] = stats.mstats.winsorize(df['Hemodialysis'], limits=[0.01, 0.01])
...
plt.xlabel('Sex')
plt.ylabel('pacemaker implantation risk')
plt.show()
